...
On this level you zoom in a little bit and show of what kind of high level elements your system should be or will be build. As an example, we're gonna have Clarity contract(s), a frontend application and we also want to use Gaia.
